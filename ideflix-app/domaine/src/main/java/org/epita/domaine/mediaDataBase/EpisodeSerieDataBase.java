...
public class EpisodeSerieDataBase {
    ...
    public EpisodeSerieDataBase() {
    }

    public EpisodeSerieDataBase(LocalDate air_date, List<Object> crew, int episode_number, List<Object> guest_stars, String name, String overview, long id, String production_code, int runtime, int season_number, String still_path, float vote_average, int vote_count) {
